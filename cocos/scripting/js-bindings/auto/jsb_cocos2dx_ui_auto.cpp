...
static bool js_cocos2dx_ui_LayoutParameter_createCloneInstance(se::State& s)
{
    cocos2d::ui::LayoutParameter* cobj = (cocos2d::ui::LayoutParameter*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_LayoutParameter_createCloneInstance : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::ui::LayoutParameter* result = cobj->createCloneInstance();
        ok &= native_ptr_to_seval<cocos2d::ui::LayoutParameter>((cocos2d::ui::LayoutParameter*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_LayoutParameter_createCloneInstance : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_LayoutParameter_createCloneInstance)

static bool js_cocos2dx_ui_LayoutParameter_copyProperties(se::State& s)
{
    cocos2d::ui::LayoutParameter* cobj = (cocos2d::ui::LayoutParameter*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_LayoutParameter_copyProperties : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_LayoutParameter_copyProperties : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_LayoutParameter_copyProperties)
...
bool js_register_cocos2dx_ui_LayoutParameter(se::Object* obj)
{
    ...
    cls->defineFunction("createCloneInstance", _SE(js_cocos2dx_ui_LayoutParameter_createCloneInstance));
    cls->defineFunction("copyProperties", _SE(js_cocos2dx_ui_LayoutParameter_copyProperties));
...
static bool js_cocos2dx_ui_LinearLayoutParameter_setGravity(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::LinearLayoutParameter::LinearGravity)tmp; } while(false);
...
static bool js_cocos2dx_ui_RelativeLayoutParameter_setAlign(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::RelativeLayoutParameter::RelativeAlign)tmp; } while(false);
...
static bool js_cocos2dx_ui_Widget_setPositionType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Widget::PositionType)tmp; } while(false);
...
static bool js_cocos2dx_ui_Widget_findNextFocusedWidget(se::State& s)
{
    ...
    if (argc == 2) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Widget::FocusDirection)tmp; } while(false);
...
static bool js_cocos2dx_ui_Widget_setBrightStyle(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Widget::BrightStyle)tmp; } while(false);
...
static bool js_cocos2dx_ui_Widget_hitTest(se::State& s)
{
    ...
    if (argc == 3) {
        ...
        bool result = cobj->hitTest(arg0, arg1, arg2);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Widget_hitTest : Error processing arguments");
        return true;
    }
...
static bool js_cocos2dx_ui_Widget_propagateTouchEvent(se::State& s)
{
    ...
    if (argc == 3) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Widget::TouchEventType)tmp; } while(false);
        ok &= seval_to_native_ptr(args[1], &arg1);
        ok &= seval_to_native_ptr(args[2], &arg2);
...
static bool js_cocos2dx_ui_Widget_setSizeType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Widget::SizeType)tmp; } while(false);
...
static bool js_cocos2dx_ui_Layout_setClippingType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Layout::ClippingType)tmp; } while(false);
...
static bool js_cocos2dx_ui_Layout_setBackGroundColorType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Layout::BackGroundColorType)tmp; } while(false);
...
static bool js_cocos2dx_ui_Layout_setBackGroundImage(se::State& s)
{
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_std_string(args[0], &arg0);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Layout_setBackGroundImage : Error processing arguments");
...
static bool js_cocos2dx_ui_Layout_setLayoutType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Layout::Type)tmp; } while(false);
...
static bool js_cocos2dx_ui_Button_setTitleLabel(se::State& s)
{
    cocos2d::ui::Button* cobj = (cocos2d::ui::Button*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Button_setTitleLabel : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Button_setTitleLabel : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_Button_setTitleLabel)
...
static bool js_cocos2dx_ui_Button_init(se::State& s)
{
    ...
    do {
        if (argc == 4) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[3], &tmp); arg3 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_Button_setTitleAlignment(se::State& s)
{
    ...
    do {
        if (argc == 2) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::TextHAlignment)tmp; } while(false);
            if (!ok) { ok = true; break; }
            cocos2d::TextVAlignment arg1;
            do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::TextVAlignment)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_Button_getTitleLabel(se::State& s)
{
    cocos2d::ui::Button* cobj = (cocos2d::ui::Button*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Button_getTitleLabel : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Label* result = cobj->getTitleLabel();
        ok &= native_ptr_to_seval<cocos2d::Label>((cocos2d::Label*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Button_getTitleLabel : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Button_getTitleLabel)
...
static bool js_cocos2dx_ui_Button_getTitleFontName(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        std::string result = cobj->getTitleFontName();
        ok &= std_string_to_seval(result, &s.rval());
...
bool js_register_cocos2dx_ui_Button(se::Object* obj)
{
    ...
    cls->defineFunction("setTitleLabel", _SE(js_cocos2dx_ui_Button_setTitleLabel));
    ...
    cls->defineFunction("getTitleLabel", _SE(js_cocos2dx_ui_Button_getTitleLabel));
...
static bool js_cocos2dx_ui_AbstractCheckButton_init(se::State& s)
{
    ...
    do {
        if (argc == 6) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[5], &tmp); arg5 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_CheckBox_create(se::State& s)
{
    ...
    do {
        if (argc == 3) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[2], &tmp); arg2 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_ImageView_getBlendFunc(se::State& s)
{
    cocos2d::ui::ImageView* cobj = (cocos2d::ui::ImageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ImageView_getBlendFunc : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ImageView_getBlendFunc : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ImageView_getBlendFunc)
...
static bool js_cocos2dx_ui_ImageView_setBlendFunc(se::State& s)
{
    cocos2d::ui::ImageView* cobj = (cocos2d::ui::ImageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ImageView_setBlendFunc : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ImageView_setBlendFunc : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ImageView_setBlendFunc)
...
bool js_register_cocos2dx_ui_ImageView(se::Object* obj)
{
    ...
    cls->defineFunction("getBlendFunc", _SE(js_cocos2dx_ui_ImageView_getBlendFunc));
    cls->defineFunction("loadTexture", _SE(js_cocos2dx_ui_ImageView_loadTexture));
    cls->defineFunction("setBlendFunc", _SE(js_cocos2dx_ui_ImageView_setBlendFunc));
...
static bool js_cocos2dx_ui_Text_disableEffect(se::State& s)
{
    ...
    do {
        if (argc == 1) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::LabelEffect)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_Text_getBlendFunc(se::State& s)
{
    cocos2d::ui::Text* cobj = (cocos2d::ui::Text*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Text_getBlendFunc : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::BlendFunc& result = cobj->getBlendFunc();
        ok &= blendfunc_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Text_getBlendFunc : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Text_getBlendFunc)
...
static bool js_cocos2dx_ui_Text_setTextVerticalAlignment(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::TextVAlignment)tmp; } while(false);
...
static bool js_cocos2dx_ui_Text_getLetter(se::State& s)
{
    cocos2d::ui::Text* cobj = (cocos2d::ui::Text*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Text_getLetter : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        int arg0 = 0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (int)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Text_getLetter : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_Text_getLetter)

static bool js_cocos2dx_ui_Text_setBlendFunc(se::State& s)
{
    cocos2d::ui::Text* cobj = (cocos2d::ui::Text*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Text_setBlendFunc : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::BlendFunc arg0;
        ok &= seval_to_blendfunc(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Text_setBlendFunc : Error processing arguments");
        cobj->setBlendFunc(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_Text_setBlendFunc)
...
bool js_register_cocos2dx_ui_Text(se::Object* obj)
{
    ...
    cls->defineFunction("getBlendFunc", _SE(js_cocos2dx_ui_Text_getBlendFunc));
    ...
    cls->defineFunction("getLetter", _SE(js_cocos2dx_ui_Text_getLetter));
    cls->defineFunction("setBlendFunc", _SE(js_cocos2dx_ui_Text_setBlendFunc));
...
static bool js_cocos2dx_ui_LoadingBar_setDirection(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::LoadingBar::Direction)tmp; } while(false);
...
static bool js_cocos2dx_ui_ScrollView_getScrolledPercentBothDirection(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentBothDirection : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Vec2 result = cobj->getScrolledPercentBothDirection();
        ok &= Vec2_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentBothDirection : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_getScrolledPercentBothDirection)
...
static bool js_cocos2dx_ui_ScrollView_setDirection(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::ScrollView::Direction)tmp; } while(false);
...
static bool js_cocos2dx_ui_ScrollView_getScrolledPercentVertical(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentVertical : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getScrolledPercentVertical();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentVertical : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_getScrolledPercentVertical)
...
static bool js_cocos2dx_ui_ScrollView_stopScroll(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_stopScroll : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
        cobj->stopScroll();
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_stopScroll)
...
static bool js_cocos2dx_ui_ScrollView_isAutoScrolling(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_isAutoScrolling : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = cobj->isAutoScrolling();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollView_isAutoScrolling : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_isAutoScrolling)
...
static bool js_cocos2dx_ui_ScrollView_getScrolledPercentHorizontal(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentHorizontal : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getScrolledPercentHorizontal();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollView_getScrolledPercentHorizontal : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_getScrolledPercentHorizontal)
...
static bool js_cocos2dx_ui_ScrollView_isScrolling(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_isScrolling : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = cobj->isScrolling();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollView_isScrolling : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_isScrolling)
...
static bool js_cocos2dx_ui_ScrollView_stopOverallScroll(se::State& s)
{
    cocos2d::ui::ScrollView* cobj = (cocos2d::ui::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollView_stopOverallScroll : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollView_stopOverallScroll)
...
bool js_register_cocos2dx_ui_ScrollView(se::Object* obj)
{
    ...
    cls->defineFunction("getScrolledPercentBothDirection", _SE(js_cocos2dx_ui_ScrollView_getScrolledPercentBothDirection));
    ...
    cls->defineFunction("getScrolledPercentVertical", _SE(js_cocos2dx_ui_ScrollView_getScrolledPercentVertical));
    ...
    cls->defineFunction("stopScroll", _SE(js_cocos2dx_ui_ScrollView_stopScroll));
    ...
    cls->defineFunction("isAutoScrolling", _SE(js_cocos2dx_ui_ScrollView_isAutoScrolling));
    ...
    cls->defineFunction("getScrolledPercentHorizontal", _SE(js_cocos2dx_ui_ScrollView_getScrolledPercentHorizontal));
    ...
    cls->defineFunction("isScrolling", _SE(js_cocos2dx_ui_ScrollView_isScrolling));
    ...
    cls->defineFunction("stopOverallScroll", _SE(js_cocos2dx_ui_ScrollView_stopOverallScroll));
...
static bool js_cocos2dx_ui_ListView_setGravity(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::ListView::Gravity)tmp; } while(false);
...
static bool js_cocos2dx_ui_ListView_getLeftPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_getLeftPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getLeftPadding();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_getLeftPadding : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ListView_getLeftPadding)
...
static bool js_cocos2dx_ui_ListView_setTopPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_setTopPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_setTopPadding : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ListView_setTopPadding)
...
static bool js_cocos2dx_ui_ListView_setMagneticType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::ListView::MagneticType)tmp; } while(false);
...
static bool js_cocos2dx_ui_ListView_setPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_setPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 4) {
        ...
        ok &= seval_to_float(args[2], &arg2);
        ok &= seval_to_float(args[3], &arg3);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_setPadding : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ListView_setPadding)
...
static bool js_cocos2dx_ui_ListView_getRightPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_getRightPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getRightPadding();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_getRightPadding : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ListView_getRightPadding)
...
static bool js_cocos2dx_ui_ListView_getTopPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_getTopPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getTopPadding();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_getTopPadding : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ListView_getTopPadding)
...
static bool js_cocos2dx_ui_ListView_setLeftPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_setLeftPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_setLeftPadding : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ListView_setLeftPadding)
...
static bool js_cocos2dx_ui_ListView_setBottomPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_setBottomPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_setBottomPadding : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ListView_setBottomPadding)
...
static bool js_cocos2dx_ui_ListView_setRightPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_setRightPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_setRightPadding : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ListView_setRightPadding)
...
static bool js_cocos2dx_ui_ListView_getBottomPadding(se::State& s)
{
    cocos2d::ui::ListView* cobj = (cocos2d::ui::ListView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ListView_getBottomPadding : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getBottomPadding();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ListView_getBottomPadding : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ListView_getBottomPadding)
...
bool js_register_cocos2dx_ui_ListView(se::Object* obj)
{
    ...
    cls->defineFunction("getLeftPadding", _SE(js_cocos2dx_ui_ListView_getLeftPadding));
    ...
    cls->defineFunction("setTopPadding", _SE(js_cocos2dx_ui_ListView_setTopPadding));
    ...
    cls->defineFunction("setPadding", _SE(js_cocos2dx_ui_ListView_setPadding));
    cls->defineFunction("removeAllItems", _SE(js_cocos2dx_ui_ListView_removeAllItems));
    cls->defineFunction("getRightPadding", _SE(js_cocos2dx_ui_ListView_getRightPadding));
    ...
    cls->defineFunction("getTopPadding", _SE(js_cocos2dx_ui_ListView_getTopPadding));
    cls->defineFunction("pushBackDefaultItem", _SE(js_cocos2dx_ui_ListView_pushBackDefaultItem));
    cls->defineFunction("setLeftPadding", _SE(js_cocos2dx_ui_ListView_setLeftPadding));
    cls->defineFunction("getClosestItemToPosition", _SE(js_cocos2dx_ui_ListView_getClosestItemToPosition));
    cls->defineFunction("setBottomPadding", _SE(js_cocos2dx_ui_ListView_setBottomPadding));
    ...
    cls->defineFunction("setRightPadding", _SE(js_cocos2dx_ui_ListView_setRightPadding));
    cls->defineFunction("setItemModel", _SE(js_cocos2dx_ui_ListView_setItemModel));
    cls->defineFunction("getBottomPadding", _SE(js_cocos2dx_ui_ListView_getBottomPadding));
...
static bool js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer(se::State& s)
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Sprite* result = cobj->getSlidBallDisabledRenderer();
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer)
...
static bool js_cocos2dx_ui_Slider_getSlidBallRenderer(se::State& s)
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Node* result = cobj->getSlidBallRenderer();
        ok &= native_ptr_to_seval<cocos2d::Node>((cocos2d::Node*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Slider_getSlidBallRenderer)
...
static bool js_cocos2dx_ui_Slider_updateVisualSlider(se::State& s)
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_updateVisualSlider : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_cocos2dx_ui_Slider_updateVisualSlider)
...
static bool js_cocos2dx_ui_Slider_getSlidBallPressedRenderer(se::State& s)
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallPressedRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Sprite* result = cobj->getSlidBallPressedRenderer();
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallPressedRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Slider_getSlidBallPressedRenderer)
...
static bool js_cocos2dx_ui_Slider_getSlidBallNormalRenderer(se::State& s)
{
    cocos2d::ui::Slider* cobj = (cocos2d::ui::Slider*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Slider_getSlidBallNormalRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Sprite* result = cobj->getSlidBallNormalRenderer();
        ok &= native_ptr_to_seval<cocos2d::Sprite>((cocos2d::Sprite*)result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Slider_getSlidBallNormalRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_Slider_getSlidBallNormalRenderer)
...
bool js_register_cocos2dx_ui_Slider(se::Object* obj)
{
    ...
    cls->defineFunction("getSlidBallDisabledRenderer", _SE(js_cocos2dx_ui_Slider_getSlidBallDisabledRenderer));
    ...
    cls->defineFunction("getSlidBallRenderer", _SE(js_cocos2dx_ui_Slider_getSlidBallRenderer));
    ...
    cls->defineFunction("updateVisualSlider", _SE(js_cocos2dx_ui_Slider_updateVisualSlider));
    cls->defineFunction("getCapInsetsProgressBarRenderer", _SE(js_cocos2dx_ui_Slider_getCapInsetsProgressBarRenderer));
    cls->defineFunction("getSlidBallPressedRenderer", _SE(js_cocos2dx_ui_Slider_getSlidBallPressedRenderer));
    ...
    cls->defineFunction("getSlidBallNormalRenderer", _SE(js_cocos2dx_ui_Slider_getSlidBallNormalRenderer));
...
static bool js_cocos2dx_ui_UICCTextField_getCharCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        size_t result = cobj->getCharCount();
...
static bool js_cocos2dx_ui_UICCTextField_create(se::State& s)
{
    ...
    do {
        if (argc == 3) {
            ...
            ok &= seval_to_float(args[2], &arg2);
            if (!ok) { ok = true; break; }
            cocos2d::ui::UICCTextField* result = cocos2d::ui::UICCTextField::create(arg0, arg1, arg2);
            ok &= native_ptr_to_seval<cocos2d::ui::UICCTextField>((cocos2d::ui::UICCTextField*)result, &s.rval());
    ...
    do {
        if (argc == 0) {
            cocos2d::ui::UICCTextField* result = cocos2d::ui::UICCTextField::create();
            ok &= native_ptr_to_seval<cocos2d::ui::UICCTextField>((cocos2d::ui::UICCTextField*)result, &s.rval());
            SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_UICCTextField_create : Error processing arguments");
            return true;
        }
...
static bool js_cocos2dx_ui_PageView_setIndicatorIndexNodesOpacity(se::State& s)
{
    cocos2d::ui::PageView* cobj = (cocos2d::ui::PageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_PageView_setIndicatorIndexNodesOpacity : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        uint8_t arg0;
        ok &= seval_to_uint8(args[0], (uint8_t*)&arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_PageView_setIndicatorIndexNodesOpacity : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_PageView_setIndicatorIndexNodesOpacity)

static bool js_cocos2dx_ui_PageView_setIndicatorSelectedIndexOpacity(se::State& s)
{
    cocos2d::ui::PageView* cobj = (cocos2d::ui::PageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_PageView_setIndicatorSelectedIndexOpacity : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        uint8_t arg0;
        ok &= seval_to_uint8(args[0], (uint8_t*)&arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_PageView_setIndicatorSelectedIndexOpacity : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_PageView_setIndicatorSelectedIndexOpacity)
...
static bool js_cocos2dx_ui_PageView_getIndicatorSelectedIndexOpacity(se::State& s)
{
    cocos2d::ui::PageView* cobj = (cocos2d::ui::PageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_PageView_getIndicatorSelectedIndexOpacity : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        uint8_t result = cobj->getIndicatorSelectedIndexOpacity();
        ok &= uint8_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_PageView_getIndicatorSelectedIndexOpacity : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_PageView_getIndicatorSelectedIndexOpacity)
...
static bool js_cocos2dx_ui_PageView_getIndicatorIndexNodesOpacity(se::State& s)
{
    cocos2d::ui::PageView* cobj = (cocos2d::ui::PageView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_PageView_getIndicatorIndexNodesOpacity : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        uint8_t result = cobj->getIndicatorIndexNodesOpacity();
        ok &= uint8_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_PageView_getIndicatorIndexNodesOpacity : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_PageView_getIndicatorIndexNodesOpacity)
...
bool js_register_cocos2dx_ui_PageView(se::Object* obj)
{
    ...
    cls->defineFunction("setIndicatorIndexNodesOpacity", _SE(js_cocos2dx_ui_PageView_setIndicatorIndexNodesOpacity));
    cls->defineFunction("setIndicatorSelectedIndexOpacity", _SE(js_cocos2dx_ui_PageView_setIndicatorSelectedIndexOpacity));
    ...
    cls->defineFunction("getIndicatorSelectedIndexOpacity", _SE(js_cocos2dx_ui_PageView_getIndicatorSelectedIndexOpacity));
    ...
    cls->defineFunction("getIndicatorIndexNodesOpacity", _SE(js_cocos2dx_ui_PageView_getIndicatorIndexNodesOpacity));
...
static bool js_cocos2dx_ui_RichElement_equalType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::RichElement::Type)tmp; } while(false);
...
static bool js_cocos2dx_ui_RichElementText_init(se::State& s)
{
    ...
    if (argc == 10) {
        ...
        ok &= seval_to_std_string(args[7], &arg7);
        ok &= seval_to_Color3B(args[8], &arg8);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[9], &tmp); arg9 = (int)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_RichElementText_init : Error processing arguments");
    ...
    if (argc == 13) {
        ...
        ok &= seval_to_Color3B(args[10], &arg10);
        ok &= seval_to_Size(args[11], &arg11);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[12], &tmp); arg12 = (int)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_RichElementText_init : Error processing arguments");
...
static bool js_cocos2dx_ui_RichElementImage_create(se::State& s)
{
    ...
    if (argc == 6) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[5], &tmp); arg5 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_RichElementImage_create : Error processing arguments");
        auto result = cocos2d::ui::RichElementImage::create(arg0, arg1, arg2, arg3, arg4, arg5);
        result->retain();
        auto obj = se::Object::createObjectWithClass(__jsb_cocos2d_ui_RichElementImage_class);
        obj->setPrivateData(result);
        s.rval().setObject(obj);
...
static bool js_cocos2dx_ui_RichText_getHorizontalAlignment(se::State& s)
{
    cocos2d::ui::RichText* cobj = (cocos2d::ui::RichText*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_RichText_getHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_RichText_getHorizontalAlignment : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_RichText_getHorizontalAlignment)

static bool js_cocos2dx_ui_RichText_setHorizontalAlignment(se::State& s)
{
    cocos2d::ui::RichText* cobj = (cocos2d::ui::RichText*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_RichText_setHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::ui::RichText::HorizontalAlignment arg0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::RichText::HorizontalAlignment)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_RichText_setHorizontalAlignment : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_RichText_setHorizontalAlignment)
...
bool js_register_cocos2dx_ui_RichText(se::Object* obj)
{
    ...
    cls->defineFunction("getHorizontalAlignment", _SE(js_cocos2dx_ui_RichText_getHorizontalAlignment));
    cls->defineFunction("setHorizontalAlignment", _SE(js_cocos2dx_ui_RichText_setHorizontalAlignment));
...
static bool js_cocos2dx_ui_Scale9Sprite_setState(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Scale9Sprite::State)tmp; } while(false);
...
static bool js_cocos2dx_ui_Scale9Sprite_setRenderingType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::Scale9Sprite::RenderingType)tmp; } while(false);
...
static bool js_cocos2dx_ui_Scale9Sprite_copyTo(se::State& s)
{
    cocos2d::ui::Scale9Sprite* cobj = (cocos2d::ui::Scale9Sprite*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_Scale9Sprite_copyTo : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_Scale9Sprite_copyTo : Error processing arguments");
        cobj->copyTo(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_Scale9Sprite_copyTo)
...
{
    auto cls = se::Class::create("Scale9Sprite", obj, __jsb_cocos2d_Sprite_proto, _SE(js_cocos2dx_ui_Scale9Sprite_constructor));
    ...
    cls->defineFunction("copyTo", _SE(js_cocos2dx_ui_Scale9Sprite_copyTo));
...
static bool js_cocos2dx_ui_EditBox_getFontSize(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontSize : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = cobj->getFontSize();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontSize : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getFontSize)
...
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_openKeyboard : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
        cobj->openKeyboard();
...
static bool js_cocos2dx_ui_EditBox_getInputMode(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getInputMode : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = (int)cobj->getInputMode();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getInputMode : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getInputMode)
...
static bool js_cocos2dx_ui_EditBox_initWithSizeAndBackgroundSprite(se::State& s)
{
    ...
    do {
        if (argc == 4) {
            ...
            ok &= seval_to_native_ptr(args[3], &arg3);
            if (!ok) { ok = true; break; }
            bool result = cobj->initWithSizeAndBackgroundSprite(arg0, arg1, arg2, arg3);
            ok &= boolean_to_seval(result, &s.rval());
            SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndBackgroundSprite : Error processing arguments");
            return true;
        }
...
static bool js_cocos2dx_ui_EditBox_getPlaceholderFontName(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontName : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const char* result = cobj->getPlaceholderFontName();
        ok &= std_string_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontName : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getPlaceholderFontName)
...
static bool js_cocos2dx_ui_EditBox_getPlaceholderFontSize(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontSize : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = cobj->getPlaceholderFontSize();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontSize : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getPlaceholderFontSize)

static bool js_cocos2dx_ui_EditBox_getCapInsetsDisabledRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getCapInsetsDisabledRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::Rect& result = cobj->getCapInsetsDisabledRenderer();
        ok &= Rect_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getCapInsetsDisabledRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getCapInsetsDisabledRenderer)
...
static bool js_cocos2dx_ui_EditBox_setCapInsetsDisabledRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setCapInsetsDisabledRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Rect arg0;
        ok &= seval_to_Rect(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setCapInsetsDisabledRenderer : Error processing arguments");
        cobj->setCapInsetsDisabledRenderer(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_setCapInsetsDisabledRenderer)
...
static bool js_cocos2dx_ui_EditBox_loadTextureDisabled(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_loadTextureDisabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_loadTextureDisabled : Error processing arguments");
        cobj->loadTextureDisabled(arg0);
        return true;
    }
    if (argc == 2) {
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_loadTextureDisabled)
...
static bool js_cocos2dx_ui_EditBox_setInputMode(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::EditBox::InputMode)tmp; } while(false);
...
static bool js_cocos2dx_ui_EditBox_getReturnType(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getReturnType : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = (int)cobj->getReturnType();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getReturnType : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getReturnType)
...
static bool js_cocos2dx_ui_EditBox_getFontName(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontName : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const char* result = cobj->getFontName();
        ok &= std_string_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontName : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getFontName)

static bool js_cocos2dx_ui_EditBox_setCapInsetsNormalRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setCapInsetsNormalRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Rect arg0;
        ok &= seval_to_Rect(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setCapInsetsNormalRenderer : Error processing arguments");
        cobj->setCapInsetsNormalRenderer(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_setCapInsetsNormalRenderer)

static bool js_cocos2dx_ui_EditBox_loadTexturePressed(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_loadTexturePressed : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_loadTexturePressed : Error processing arguments");
        cobj->loadTexturePressed(arg0);
        return true;
    }
    if (argc == 2) {
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_loadTexturePressed)

static bool js_cocos2dx_ui_EditBox_getFontColor(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getFontColor : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::Color4B& result = cobj->getFontColor();
        ok &= Color4B_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getFontColor : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getFontColor)

static bool js_cocos2dx_ui_EditBox_getInputFlag(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getInputFlag : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = (int)cobj->getInputFlag();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getInputFlag : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getInputFlag)

static bool js_cocos2dx_ui_EditBox_initWithSizeAndTexture(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= seval_to_Size(args[0], &arg0);
        ok &= seval_to_std_string(args[1], &arg1);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        bool result = cobj->initWithSizeAndTexture(arg0, arg1);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        return true;
    }
    if (argc == 3) {
        ...
        ok &= seval_to_std_string(args[2], &arg2);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        bool result = cobj->initWithSizeAndTexture(arg0, arg1, arg2);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        return true;
    }
    if (argc == 4) {
        ...
        ok &= seval_to_std_string(args[3], &arg3);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        bool result = cobj->initWithSizeAndTexture(arg0, arg1, arg2, arg3);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        return true;
    }
    if (argc == 5) {
        ...
        ok &= seval_to_std_string(args[2], &arg2);
        ok &= seval_to_std_string(args[3], &arg3);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[4], &tmp); arg4 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        bool result = cobj->initWithSizeAndTexture(arg0, arg1, arg2, arg3, arg4);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_initWithSizeAndTexture : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_initWithSizeAndTexture)

static bool js_cocos2dx_ui_EditBox_getTextHorizontalAlignment(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getTextHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = (int)cobj->getTextHorizontalAlignment();
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getTextHorizontalAlignment : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getTextHorizontalAlignment)

static bool js_cocos2dx_ui_EditBox_getCapInsetsNormalRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getCapInsetsNormalRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::Rect& result = cobj->getCapInsetsNormalRenderer();
        ok &= Rect_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getCapInsetsNormalRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getCapInsetsNormalRenderer)

static bool js_cocos2dx_ui_EditBox_getCapInsetsPressedRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getCapInsetsPressedRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::Rect& result = cobj->getCapInsetsPressedRenderer();
        ok &= Rect_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getCapInsetsPressedRenderer : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getCapInsetsPressedRenderer)

static bool js_cocos2dx_ui_EditBox_loadTextures(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_loadTextures : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= seval_to_std_string(args[0], &arg0);
        ok &= seval_to_std_string(args[1], &arg1);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_loadTextures : Error processing arguments");
        cobj->loadTextures(arg0, arg1);
        return true;
    }
    if (argc == 3) {
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_loadTextures)
...
static bool js_cocos2dx_ui_EditBox_setInputFlag(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::EditBox::InputFlag)tmp; } while(false);
...
static bool js_cocos2dx_ui_EditBox_setReturnType(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::EditBox::KeyboardReturnType)tmp; } while(false);
...
static bool js_cocos2dx_ui_EditBox_loadTextureNormal(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_loadTextureNormal : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        std::string arg0;
        ok &= seval_to_std_string(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_loadTextureNormal : Error processing arguments");
        cobj->loadTextureNormal(arg0);
        return true;
    }
    if (argc == 2) {
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_loadTextureNormal)
...
static bool js_cocos2dx_ui_EditBox_setCapInsetsPressedRenderer(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setCapInsetsPressedRenderer : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Rect arg0;
        ok &= seval_to_Rect(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setCapInsetsPressedRenderer : Error processing arguments");
        cobj->setCapInsetsPressedRenderer(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_setCapInsetsPressedRenderer)
...
static bool js_cocos2dx_ui_EditBox_getPlaceholderFontColor(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontColor : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const cocos2d::Color4B& result = cobj->getPlaceholderFontColor();
        ok &= Color4B_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_getPlaceholderFontColor : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_getPlaceholderFontColor)

static bool js_cocos2dx_ui_EditBox_setCapInsets(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setCapInsets : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Rect arg0;
        ok &= seval_to_Rect(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setCapInsets : Error processing arguments");
        cobj->setCapInsets(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_setCapInsets)
...
static bool js_cocos2dx_ui_EditBox_setTextHorizontalAlignment(se::State& s)
{
    cocos2d::ui::EditBox* cobj = (cocos2d::ui::EditBox*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_EditBox_setTextHorizontalAlignment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::TextHAlignment arg0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::TextHAlignment)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_setTextHorizontalAlignment : Error processing arguments");
        cobj->setTextHorizontalAlignment(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_EditBox_setTextHorizontalAlignment)
...
static bool js_cocos2dx_ui_EditBox_create(se::State& s)
{
    ...
    do {
        if (argc == 5) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[4], &tmp); arg4 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
            if (!ok) { ok = true; break; }
            cocos2d::ui::EditBox* result = cocos2d::ui::EditBox::create(arg0, arg1, arg2, arg3, arg4);
            ok &= native_ptr_to_seval<cocos2d::ui::EditBox>((cocos2d::ui::EditBox*)result, &s.rval());
            SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_EditBox_create : Error processing arguments");
            return true;
        }
...
bool js_register_cocos2dx_ui_EditBox(se::Object* obj)
{
    ...
    cls->defineFunction("getFontSize", _SE(js_cocos2dx_ui_EditBox_getFontSize));
    ...
    cls->defineFunction("openKeyboard", _SE(js_cocos2dx_ui_EditBox_openKeyboard));
    cls->defineFunction("setFontSize", _SE(js_cocos2dx_ui_EditBox_setFontSize));
    cls->defineFunction("getInputMode", _SE(js_cocos2dx_ui_EditBox_getInputMode));
    cls->defineFunction("initWithSizeAndBackgroundSprite", _SE(js_cocos2dx_ui_EditBox_initWithSizeAndBackgroundSprite));
    cls->defineFunction("getPlaceholderFontName", _SE(js_cocos2dx_ui_EditBox_getPlaceholderFontName));
    cls->defineFunction("setPlaceholderFontName", _SE(js_cocos2dx_ui_EditBox_setPlaceholderFontName));
    cls->defineFunction("getPlaceholderFontSize", _SE(js_cocos2dx_ui_EditBox_getPlaceholderFontSize));
    cls->defineFunction("getCapInsetsDisabledRenderer", _SE(js_cocos2dx_ui_EditBox_getCapInsetsDisabledRenderer));
    ...
    cls->defineFunction("setCapInsetsDisabledRenderer", _SE(js_cocos2dx_ui_EditBox_setCapInsetsDisabledRenderer));
    cls->defineFunction("setPlaceholderFontSize", _SE(js_cocos2dx_ui_EditBox_setPlaceholderFontSize));
    cls->defineFunction("loadTextureDisabled", _SE(js_cocos2dx_ui_EditBox_loadTextureDisabled));
    ...
    cls->defineFunction("getReturnType", _SE(js_cocos2dx_ui_EditBox_getReturnType));
    cls->defineFunction("setFontColor", _SE(js_cocos2dx_ui_EditBox_setFontColor));
    cls->defineFunction("getFontName", _SE(js_cocos2dx_ui_EditBox_getFontName));
    cls->defineFunction("setCapInsetsNormalRenderer", _SE(js_cocos2dx_ui_EditBox_setCapInsetsNormalRenderer));
    cls->defineFunction("loadTexturePressed", _SE(js_cocos2dx_ui_EditBox_loadTexturePressed));
    cls->defineFunction("getFontColor", _SE(js_cocos2dx_ui_EditBox_getFontColor));
    cls->defineFunction("getInputFlag", _SE(js_cocos2dx_ui_EditBox_getInputFlag));
    cls->defineFunction("initWithSizeAndTexture", _SE(js_cocos2dx_ui_EditBox_initWithSizeAndTexture));
    cls->defineFunction("getTextHorizontalAlignment", _SE(js_cocos2dx_ui_EditBox_getTextHorizontalAlignment));
    cls->defineFunction("getCapInsetsNormalRenderer", _SE(js_cocos2dx_ui_EditBox_getCapInsetsNormalRenderer));
    cls->defineFunction("getCapInsetsPressedRenderer", _SE(js_cocos2dx_ui_EditBox_getCapInsetsPressedRenderer));
    cls->defineFunction("loadTextures", _SE(js_cocos2dx_ui_EditBox_loadTextures));
    ...
    cls->defineFunction("loadTextureNormal", _SE(js_cocos2dx_ui_EditBox_loadTextureNormal));
    cls->defineFunction("getMaxLength", _SE(js_cocos2dx_ui_EditBox_getMaxLength));
    cls->defineFunction("setCapInsetsPressedRenderer", _SE(js_cocos2dx_ui_EditBox_setCapInsetsPressedRenderer));
    cls->defineFunction("setPlaceholderFont", _SE(js_cocos2dx_ui_EditBox_setPlaceholderFont));
    cls->defineFunction("getPlaceholderFontColor", _SE(js_cocos2dx_ui_EditBox_getPlaceholderFontColor));
    cls->defineFunction("setCapInsets", _SE(js_cocos2dx_ui_EditBox_setCapInsets));
    cls->defineFunction("setFont", _SE(js_cocos2dx_ui_EditBox_setFont));
    cls->defineFunction("setTextHorizontalAlignment", _SE(js_cocos2dx_ui_EditBox_setTextHorizontalAlignment));
...
static bool js_cocos2dx_ui_LayoutComponent_setVerticalEdge(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::LayoutComponent::VerticalEdge)tmp; } while(false);
...
static bool js_cocos2dx_ui_LayoutComponent_setHorizontalEdge(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::LayoutComponent::HorizontalEdge)tmp; } while(false);
...
static bool js_cocos2dx_ui_TabHeader_create(se::State& s)
{
    ...
    do {
        if (argc == 7) {
            ...
            do { int32_t tmp = 0; ok &= seval_to_int32(args[6], &tmp); arg6 = (cocos2d::ui::Widget::TextureResType)tmp; } while(false);
            if (!ok) { ok = true; break; }
...
static bool js_cocos2dx_ui_TabControl_getTabCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        size_t result = cobj->getTabCount();
        ok &= uint32_to_seval(result, &s.rval());
...
static bool js_cocos2dx_ui_TabControl_setHeaderDockPlace(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::ui::TabControl::Dock)tmp; } while(false);
...
se::Object* __jsb_cocos2d_ui_ScrollViewBar_proto = nullptr;
se::Class* __jsb_cocos2d_ui_ScrollViewBar_class = nullptr;

static bool js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled)

static bool js_cocos2dx_ui_ScrollViewBar_onScrolled(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_onScrolled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Vec2 arg0;
        ok &= seval_to_Vec2(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_onScrolled : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_onScrolled)

static bool js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = cobj->isAutoHideEnabled();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled)

static bool js_cocos2dx_ui_ScrollViewBar_setAutoHideTime(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideTime : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setAutoHideTime : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_setAutoHideTime)

static bool js_cocos2dx_ui_ScrollViewBar_getWidth(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getWidth : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getWidth : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_getWidth)

static bool js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cocos2d::Vec2 result = cobj->getPositionFromCorner();
        ok &= Vec2_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner)

static bool js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::Vec2 arg0;
        ok &= seval_to_Vec2(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner)

static bool js_cocos2dx_ui_ScrollViewBar_getAutoHideTime(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_getAutoHideTime : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getAutoHideTime();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_getAutoHideTime : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_getAutoHideTime)

static bool js_cocos2dx_ui_ScrollViewBar_setWidth(se::State& s)
{
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_ui_ScrollViewBar_setWidth : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        float arg0 = 0;
        ok &= seval_to_float(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_setWidth : Error processing arguments");
        cobj->setWidth(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_setWidth)

static bool js_cocos2dx_ui_ScrollViewBar_create(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::ui::ScrollView::Direction)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_create : Error processing arguments");
        auto result = cocos2d::ui::ScrollViewBar::create(arg0, arg1);
        result->retain();
        auto obj = se::Object::createObjectWithClass(__jsb_cocos2d_ui_ScrollViewBar_class);
        obj->setPrivateData(result);
        s.rval().setObject(obj);
        return true;
    }
...
SE_BIND_FUNC(js_cocos2dx_ui_ScrollViewBar_create)

SE_DECLARE_FINALIZE_FUNC(js_cocos2d_ui_ScrollViewBar_finalize)

static bool js_cocos2dx_ui_ScrollViewBar_constructor(se::State& s)
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    cocos2d::ui::ScrollView* arg0 = nullptr;
    ...
    ok &= seval_to_native_ptr(args[0], &arg0);
    do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::ui::ScrollView::Direction)tmp; } while(false);
    SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_constructor : Error processing arguments");
    cocos2d::ui::ScrollViewBar* cobj = new (std::nothrow) cocos2d::ui::ScrollViewBar(arg0, arg1);
    s.thisObject()->setPrivateData(cobj);
    return true;
}
SE_BIND_CTOR(js_cocos2dx_ui_ScrollViewBar_constructor, __jsb_cocos2d_ui_ScrollViewBar_class, js_cocos2d_ui_ScrollViewBar_finalize)

static bool js_cocos2dx_ui_ScrollViewBar_ctor(se::State& s)
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    cocos2d::ui::ScrollView* arg0 = nullptr;
    ...
    ok &= seval_to_native_ptr(args[0], &arg0);
    do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::ui::ScrollView::Direction)tmp; } while(false);
    SE_PRECONDITION2(ok, false, "js_cocos2dx_ui_ScrollViewBar_ctor : Error processing arguments");
    cocos2d::ui::ScrollViewBar* cobj = new (std::nothrow) cocos2d::ui::ScrollViewBar(arg0, arg1);
    s.thisObject()->setPrivateData(cobj);
    return true;
}
SE_BIND_SUB_CLS_CTOR(js_cocos2dx_ui_ScrollViewBar_ctor, __jsb_cocos2d_ui_ScrollViewBar_class, js_cocos2d_ui_ScrollViewBar_finalize)
...
static bool js_cocos2d_ui_ScrollViewBar_finalize(se::State& s)
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::ui::ScrollViewBar)", s.nativeThisObject());
    cocos2d::ui::ScrollViewBar* cobj = (cocos2d::ui::ScrollViewBar*)s.nativeThisObject();
    cobj->release();
    return true;
}
SE_BIND_FINALIZE_FUNC(js_cocos2d_ui_ScrollViewBar_finalize)

bool js_register_cocos2dx_ui_ScrollViewBar(se::Object* obj)
{
    auto cls = se::Class::create("ScrollViewBar", obj, __jsb_cocos2d_ProtectedNode_proto, _SE(js_cocos2dx_ui_ScrollViewBar_constructor));

    cls->defineFunction("setAutoHideEnabled", _SE(js_cocos2dx_ui_ScrollViewBar_setAutoHideEnabled));
    cls->defineFunction("onScrolled", _SE(js_cocos2dx_ui_ScrollViewBar_onScrolled));
    cls->defineFunction("isAutoHideEnabled", _SE(js_cocos2dx_ui_ScrollViewBar_isAutoHideEnabled));
    cls->defineFunction("setAutoHideTime", _SE(js_cocos2dx_ui_ScrollViewBar_setAutoHideTime));
    cls->defineFunction("getWidth", _SE(js_cocos2dx_ui_ScrollViewBar_getWidth));
    cls->defineFunction("getPositionFromCorner", _SE(js_cocos2dx_ui_ScrollViewBar_getPositionFromCorner));
    cls->defineFunction("setPositionFromCorner", _SE(js_cocos2dx_ui_ScrollViewBar_setPositionFromCorner));
    cls->defineFunction("getAutoHideTime", _SE(js_cocos2dx_ui_ScrollViewBar_getAutoHideTime));
    cls->defineFunction("setWidth", _SE(js_cocos2dx_ui_ScrollViewBar_setWidth));
    cls->defineFunction("ctor", _SE(js_cocos2dx_ui_ScrollViewBar_ctor));
    cls->defineStaticFunction("create", _SE(js_cocos2dx_ui_ScrollViewBar_create));
    cls->defineFinalizeFunction(_SE(js_cocos2d_ui_ScrollViewBar_finalize));
    cls->install();
    JSBClassType::registerClass<cocos2d::ui::ScrollViewBar>(cls);

    __jsb_cocos2d_ui_ScrollViewBar_proto = cls->getProto();
    __jsb_cocos2d_ui_ScrollViewBar_class = cls;

    jsb_set_extend_property("ccui", "ScrollViewBar");
    se::ScriptEngine::getInstance()->clearException();
    return true;
}
...
bool register_all_cocos2dx_ui(se::Object* obj)
{
    ...
    js_register_cocos2dx_ui_ScrollViewBar(ns);
