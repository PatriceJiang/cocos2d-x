...
static bool js_cocos2dx_experimental_webView_WebView_setOpacityWebView(se::State& s)
{
    cocos2d::experimental::ui::WebView* cobj = (cocos2d::experimental::ui::WebView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_webView_WebView_setOpacityWebView : Invalid Native Object");
    ...
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_webView_WebView_setOpacityWebView : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_experimental_webView_WebView_setOpacityWebView)
...
static bool js_cocos2dx_experimental_webView_WebView_setBackgroundTransparent(se::State& s)
{
    cocos2d::experimental::ui::WebView* cobj = (cocos2d::experimental::ui::WebView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_webView_WebView_setBackgroundTransparent : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_cocos2dx_experimental_webView_WebView_setBackgroundTransparent)
...
static bool js_cocos2dx_experimental_webView_WebView_getOnShouldStartLoading(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        std::function<bool (cocos2d::experimental::ui::WebView *, const std::string&)> result = cobj->getOnShouldStartLoading();
        #pragma warning NO CONVERSION FROM NATIVE FOR std::function;
...
static bool js_cocos2dx_experimental_webView_WebView_getOpacityWebView(se::State& s)
{
    cocos2d::experimental::ui::WebView* cobj = (cocos2d::experimental::ui::WebView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_webView_WebView_getOpacityWebView : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        float result = cobj->getOpacityWebView();
        ok &= float_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_webView_WebView_getOpacityWebView : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_experimental_webView_WebView_getOpacityWebView)
...
static bool js_cocos2dx_experimental_webView_WebView_create(se::State& s)
{
    ...
    if (argc == 0) {
        ...
        result->retain();
        auto obj = se::Object::createObjectWithClass(__jsb_cocos2d_experimental_ui_WebView_class);
...
bool js_register_cocos2dx_experimental_webView_WebView(se::Object* obj)
{
    ...
    cls->defineFunction("setOpacityWebView", _SE(js_cocos2dx_experimental_webView_WebView_setOpacityWebView));
    ...
    cls->defineFunction("setBackgroundTransparent", _SE(js_cocos2dx_experimental_webView_WebView_setBackgroundTransparent));
    ...
    cls->defineFunction("getOpacityWebView", _SE(js_cocos2dx_experimental_webView_WebView_getOpacityWebView));
