...
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled);
...
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setStyle);
...
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_isLooping);
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_isPlaying);
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setLooping);
SE_DECLARE_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled);
