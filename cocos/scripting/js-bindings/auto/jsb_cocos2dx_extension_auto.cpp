...
static bool js_cocos2dx_extension_ControlButton_setTitleLabelForState(se::State& s)
{
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::extension::Control::State)tmp; } while(false);
...
static bool js_cocos2dx_extension_ControlButton_getTitleTTFSizeForState(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::extension::Control::State)tmp; } while(false);
...
static bool js_cocos2dx_extension_ControlColourPicker_hueSliderValueChanged(se::State& s)
{
    ...
    if (argc == 2) {
        ...
        ok &= seval_to_native_ptr(args[0], &arg0);
        do { int32_t tmp = 0; ok &= seval_to_int32(args[1], &tmp); arg1 = (cocos2d::extension::Control::EventType)tmp; } while(false);
...
static bool js_cocos2dx_extension_ScrollView_setSwallowTouches(se::State& s)
{
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_ScrollView_setSwallowTouches : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_ScrollView_setSwallowTouches : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_extension_ScrollView_setSwallowTouches)
...
static bool js_cocos2dx_extension_ScrollView_initWithViewSize(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        bool result = cobj->initWithViewSize(arg0);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_ScrollView_initWithViewSize : Error processing arguments");
        return true;
    }
...
static bool js_cocos2dx_extension_ScrollView_setDirection(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::extension::ScrollView::Direction)tmp; } while(false);
...
static bool js_cocos2dx_extension_ScrollView_create(se::State& s)
{
    ...
    do {
        if (argc == 1) {
            ...
            ok &= seval_to_Size(args[0], &arg0);
            if (!ok) { ok = true; break; }
            cocos2d::extension::ScrollView* result = cocos2d::extension::ScrollView::create(arg0);
            ok &= native_ptr_to_seval<cocos2d::extension::ScrollView>((cocos2d::extension::ScrollView*)result, &s.rval());
            SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_ScrollView_create : Error processing arguments");
            return true;
        }
...
bool js_register_cocos2dx_extension_ScrollView(se::Object* obj)
{
    ...
    cls->defineFunction("setSwallowTouches", _SE(js_cocos2dx_extension_ScrollView_setSwallowTouches));
...
static bool js_cocos2dx_extension_TableView_setVerticalFillOrder(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::extension::TableView::VerticalFillOrder)tmp; } while(false);
