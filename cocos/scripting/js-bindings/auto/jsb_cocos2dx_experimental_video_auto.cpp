...
static bool js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled(se::State& s)
{
    cocos2d::experimental::ui::VideoPlayer* cobj = (cocos2d::experimental::ui::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = cobj->isUserInputEnabled();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled)
...
static bool js_cocos2dx_experimental_video_VideoPlayer_setStyle(se::State& s)
{
    cocos2d::experimental::ui::VideoPlayer* cobj = (cocos2d::experimental::ui::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_video_VideoPlayer_setStyle : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cocos2d::experimental::ui::VideoPlayer::StyleType arg0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cocos2d::experimental::ui::VideoPlayer::StyleType)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_video_VideoPlayer_setStyle : Error processing arguments");
        cobj->setStyle(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setStyle)
...
static bool js_cocos2dx_experimental_video_VideoPlayer_isLooping(se::State& s)
{
    cocos2d::experimental::ui::VideoPlayer* cobj = (cocos2d::experimental::ui::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_video_VideoPlayer_isLooping : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        bool result = cobj->isLooping();
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_video_VideoPlayer_isLooping : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_experimental_video_VideoPlayer_isLooping)
...
static bool js_cocos2dx_experimental_video_VideoPlayer_setLooping(se::State& s)
{
    cocos2d::experimental::ui::VideoPlayer* cobj = (cocos2d::experimental::ui::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_video_VideoPlayer_setLooping : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_video_VideoPlayer_setLooping : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setLooping)

static bool js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled(se::State& s)
{
    cocos2d::experimental::ui::VideoPlayer* cobj = (cocos2d::experimental::ui::VideoPlayer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled)
...
bool js_register_cocos2dx_experimental_video_VideoPlayer(se::Object* obj)
{
    ...
    cls->defineFunction("isUserInputEnabled", _SE(js_cocos2dx_experimental_video_VideoPlayer_isUserInputEnabled));
    ...
    cls->defineFunction("setStyle", _SE(js_cocos2dx_experimental_video_VideoPlayer_setStyle));
    ...
    cls->defineFunction("isLooping", _SE(js_cocos2dx_experimental_video_VideoPlayer_isLooping));
    cls->defineFunction("isPlaying", _SE(js_cocos2dx_experimental_video_VideoPlayer_isPlaying));
    cls->defineFunction("setLooping", _SE(js_cocos2dx_experimental_video_VideoPlayer_setLooping));
    cls->defineFunction("setUserInputEnabled", _SE(js_cocos2dx_experimental_video_VideoPlayer_setUserInputEnabled));
